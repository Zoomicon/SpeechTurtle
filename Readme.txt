...
Project Description
--------------------
Control a Turtle character on a 2D canvas using speech, either using the default audio input source
on Windows, or using Microsoft Kinect
...
- To use with Kinect for Windows v1 sensor (optional), you just need Kinect for Windows Runtime 1.8 installed (unless you have
Kinect for Xbox 360 sensor, in which case you need the Kinect for Windows SDK 1.8 instead - it does contains the Runtime too)
...
Credits
--------
Based on the sample "SpeechBasics-WPF" for C# (https://msdn.microsoft.com/en-us/library/hh855387.aspx
